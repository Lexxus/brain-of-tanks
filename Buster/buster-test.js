...
/*global module, require, sinon*/
/**
 * Tests function, sandboxes fakes
 *
 * @author Christian Johansen (christian@cjohansen.no)
 * @license BSD
 *
...
/*global module, require, sinon*/
/**
 * Tests case, sandboxes all test functions
 *
 * @author Christian Johansen (christian@cjohansen.no)
 * @license BSD
 *
...
(function (B, when) {
    ...
    var testCase = function (name, tests) {
        if (!name || typeof name != "string") {
            throw new Error("Tests case name required");
        }
    ...
    var htmlReporter = {
        ...
        setRoot: function (root) {
            ...
            if (this.root == body) {
                ...
                addCSS(head);
                insertTitle(this.doc, body, this.doc.title || "Buster.JS Tests case");
        ...
        addStats: function (stats) {
            ...
            statsEl.appendChild(el(this.doc, "h2", {
                text: this.success(stats) ? "Tests OK" : "Tests failures!"
            }));
